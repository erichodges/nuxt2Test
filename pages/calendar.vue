...
export default {
  ...
  methods: {
    ...
    getData () {
      return axios
        .get(`https://sheets.googleapis.com/v4/spreadsheets/1IGposbdT8R8j6UdmGtAFgI_39LZL8UWOIIpnsyC23mM/values/Sheet2?valueRenderOption=FORMATTED_VALUE&key=${process.env.TEACHERS_KEY}`)
        .then(response => {
